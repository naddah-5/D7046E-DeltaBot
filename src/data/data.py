...
class DeltaData():
    ...
    def __init__(self,embedder, embedding_size : int, csv_source_path="",csv_proceed_path="",train_proportion =0.8,val_proportion=0.1,test_proportion=0.1):
    ...
    def getTrainingSet(self) -> DeltaDataset:
        return self.train

    def getValidationSet(self)-> DeltaDataset:
        return self.val

    def getTestingSet(self)-> DeltaDataset:
        return self.test
